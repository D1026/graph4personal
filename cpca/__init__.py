...
def _data_from_csv() -> (AddrMap, AddrMap, AddrMap, dict, dict):
    ...
    with open('data/zxb2GraphA13/cpca/resources/pca.csv', newline='') as csvfile:
        pca_csv = csv.DictReader(csvfile)
